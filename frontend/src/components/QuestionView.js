        ...
        <div className="categories-list">
          ...
          <ul>
            {Object.keys(this.state.categories).map((id, ind) => (
              <li key={id} onClick={() => {this.getByCategory(this.state.categories[ind].id)}}>
                {this.state.categories[ind].type} 
                <img className="category" src={`${this.state.categories[ind].type}.svg`}/>
              </li>
            ))}
          </ul>
        ...
        <div className="questions-list">
          ...
          {this.state.questions.map((q, ind) => (
            ...
            <Question
              ...
              question={q.question}
              answer={q.answer}
              category={this.state.categories.filter(c=> c.id==Number(q.category))[0].type} 
